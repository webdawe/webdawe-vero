 ...
 * @license
 */
class Webdawe_Vero_Model_Quote extends Mage_Core_Model_Abstract
{
	const EVENT_OBJECT = 'quote';
	 ...
	 * @var string
	 */
	const EVENT_PREFIX = 'webdawe_vero_quote';
