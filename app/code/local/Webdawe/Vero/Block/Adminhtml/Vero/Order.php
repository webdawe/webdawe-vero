 ...
 * @license
 */
class Webdawe_Vero_Block_Adminhtml_Vero_Order extends Mage_Adminhtml_Block_Widget_Grid_Container
{

	public function __construct()
	{
		$this->_controller = "adminhtml_vero_order";
		$this->_blockGroup = "webdawe_vero";
		$this->_headerText = Mage::helper("webdawe_vero")->__("Vero Orders");
