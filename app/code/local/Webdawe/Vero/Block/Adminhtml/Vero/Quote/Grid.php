 ...
 * @license
 */
class Webdawe_Vero_Block_Adminhtml_Vero_Quote_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
		public function __construct()
		{
			parent::__construct();
			$this->setId("veroQuoteGrid");
		...
		{
			$collection = Mage::getModel("webdawe_vero/quote")->getCollection();
		...
		protected function _prepareMassaction()
		{
			...
			$this->getMassactionBlock()->addItem('remove_vero_quote', array(
					 'label'=> Mage::helper('webdawe_vero')->__('Remove Vero Quote'),
					 'url'  => $this->getUrl('adminhtml/vero_quote/massRemove'),
