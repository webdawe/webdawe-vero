 ...
 * @license
 */
class Webdawe_Vero_Block_Adminhtml_Vero_Customer extends Mage_Adminhtml_Block_Widget_Grid_Container
{

	public function __construct()
	{
		$this->_controller = "adminhtml_vero_customer";
		$this->_blockGroup = "webdawe_vero";
		$this->_headerText = Mage::helper("webdawe_vero")->__("Vero Customers");
