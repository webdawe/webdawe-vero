 ...
 * @license
 */
class Webdawe_Vero_Block_Adminhtml_Vero_Quote extends Mage_Adminhtml_Block_Widget_Grid_Container
{

	public function __construct()
	{
		$this->_controller = "adminhtml_vero_quote";
		$this->_blockGroup = "webdawe_vero";
		$this->_headerText = Mage::helper("webdawe_vero")->__("Vero Quotes");
